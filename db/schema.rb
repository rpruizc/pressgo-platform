...
ActiveRecord::Schema[8.1].define(version: 2026_02_15_200000) do
  ...
  create_table "newsletter_configs", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.boolean "autopilot_enabled", default: false, null: false
    t.string "cadence", null: false
    t.datetime "created_at", null: false
    t.integer "default_send_hour", default: 9, null: false
    t.integer "default_send_minute", default: 0, null: false
    t.string "default_send_timezone", default: "UTC", null: false
    t.integer "default_send_weekday", default: 1, null: false
    t.integer "story_count", default: 5, null: false
    t.string "template_key", null: false
    t.string "tone", default: "balanced", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_newsletter_configs_on_account_id", unique: true
    t.index ["cadence"], name: "index_newsletter_configs_on_cadence"
  end
  ...
  add_foreign_key "newsletter_configs", "accounts"
